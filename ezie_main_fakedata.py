...
if plot_summary:
    ...
    plt.savefig('./ezl_gini.pdf', format='pdf', bbox_inches='tight')
    plt.savefig('./ezl_gini.png', bbox_inches='tight')
    plt.close('all')
    plt.ion()
...
if plot_summary:
    ...
    plt.savefig('./ezl_lcurve.pdf', format='pdf', bbox_inches='tight')
    plt.savefig('./ezl_lcurve.png', bbox_inches='tight')
    plt.close('all')
    plt.ion()
...
plt.plot([PD_xi[0], PD_xi[0], PD_xi[1], PD_xi[1], PD_xi[0]], 
         [PD_eta[0], PD_eta[1], PD_eta[1], PD_eta[0], PD_eta[0]],
         color='k', linewidth=3)
plt.savefig('./ezl_PD_and_flag.pdf', format='pdf', bbox_inches='tight')
plt.savefig('./ezl_PD_and_flag.png', bbox_inches='tight')
plt.close('all')
plt.ion()
...
plt.savefig('./data_prediction_comparison.png', bbox_inches='tight')
plt.savefig('./data_prediction_comparison.pdf', format='pdf', bbox_inches='tight')

axs[0].set_ylim([-500, 800])
axs[1].set_ylim([-750, 1000])

plt.savefig('./data_prediction_comparison_zoom.png', bbox_inches='tight')
plt.savefig('./data_prediction_comparison_zoom.pdf', format='pdf', bbox_inches='tight')
plt.close('all')
plt.ion()
