...
DT = 6
OBSHEIGHT = 80e3 # assumed observation height in m
...
tm = data.index[data.index.get_indexer([info['tm']], method='nearest')[0]]
...
# midpoint already computed: tm
half = dt.timedelta(seconds=DT/2*60)
t0 = data.index[data.index.get_indexer([tm - half], method="nearest")[0]]
t1 = data.index[data.index.get_indexer([tm + half], method="nearest")[0]]

#
#t0 = data.index[data.index.get_indexer([tm - dt.timedelta(seconds=DT/2*60)], method="nearest")[0]]
#t1 = data.index[data.index.get_indexer([tm + dt.timedelta(seconds=DT/2*60)], method="nearest")[0]]
...
if plot_summary:
    ...
    plt.savefig('./ezl_gini_realdata.pdf', format='pdf', bbox_inches='tight')
    plt.savefig('./ezl_gini_realdata.png', bbox_inches='tight')
    plt.close('all')
    plt.ion()
...
if plot_summary:
    ...
    plt.savefig('./ezl_lcurve_realdata.pdf', format='pdf', bbox_inches='tight')
    plt.savefig('./ezl_lcurve_realdata.png', bbox_inches='tight')
    plt.close('all')
    plt.ion()
...
plt.plot([PD_xi[0], PD_xi[0], PD_xi[1], PD_xi[1], PD_xi[0]], 
         [PD_eta[0], PD_eta[1], PD_eta[1], PD_eta[0], PD_eta[0]],
         color='k', linewidth=3)
plt.savefig('./ezl_PD_and_flag_realdata.pdf', format='pdf', bbox_inches='tight')
plt.savefig('./ezl_PD_and_flag_realdata.png', bbox_inches='tight')
plt.close('all')
plt.ion()
...
plt.savefig('./data_prediction_comparison_realdata.png', bbox_inches='tight')
plt.savefig('./data_prediction_comparison_realdata.pdf', format='pdf', bbox_inches='tight')

axs[0].set_ylim([-500, 800])
axs[1].set_ylim([-750, 1000])

plt.savefig('./data_prediction_comparison_zoom_realdata.png', bbox_inches='tight')
plt.savefig('./data_prediction_comparison_zoom_realdata.pdf', format='pdf', bbox_inches='tight')
plt.close('all')
plt.ion()
