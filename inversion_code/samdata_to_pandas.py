...
path = '/Users/laundal/BCSS-DAG Dropbox/Data/EZIE/osse_saves/'
path = '/Users/laundal/Downloads/missing_events/'
fns = [path + fn for fn in os.listdir(path) if fn.endswith('sav')]
