...
Use \cite{Gjerloev11} FAC-based spectrum to make synthetic equivalent current that has the same magnetic field spatial power spectrum. Use standard radial dependence to calculate structure and magnitude of magnetic field below ionosphere. The result is a theoretical prediction of the average magnitude of the magnetic field perturbations as function of altitude (or distance from electrojet current sheet). The point is to quantify the added benefit of measuring at 85 km compared to ground. 

Figures \ref{fig:b_vs_h} and \ref{fig:maps} show results from when I did this calculation earlier. I plan to repeat it now, and include code and documentation. The two figures will be merged into one which will also contain a panel with the the \cite{Gjerloev11} power spectrum which is used in the calculation. 
